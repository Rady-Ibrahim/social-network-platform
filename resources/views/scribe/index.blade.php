...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://socialplatform:82";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-posts--post_id--like">POST api/posts/{post_id}/like</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-posts--post_id--like">
                                <a href="#endpoints-DELETEapi-posts--post_id--like">DELETE api/posts/{post_id}/like</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-posts--post_id--likes">
                                <a href="#endpoints-GETapi-posts--post_id--likes">GET api/posts/{post_id}/likes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-friends">
                                <a href="#endpoints-GETapi-friends">GET api/friends</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-friend-requests">
                                <a href="#endpoints-GETapi-friend-requests">GET api/friend-requests</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-friend-requests">
                                <a href="#endpoints-POSTapi-friend-requests">POST api/friend-requests</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-friend-requests--friend_request--accept">
                                <a href="#endpoints-POSTapi-friend-requests--friend_request--accept">POST api/friend-requests/{friend_request}/accept</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-friend-requests--friend_request--reject">
                                <a href="#endpoints-POSTapi-friend-requests--friend_request--reject">POST api/friend-requests/{friend_request}/reject</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-friend-requests--friend_request-">
                                <a href="#endpoints-DELETEapi-friend-requests--friend_request-">DELETE api/friend-requests/{friend_request}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="users">
                    <a href="#users">Users</a>
                                ...
                                <a href="#users-GETapi-users">Search users.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-GETapi-users--user_id-">
                                <a href="#users-GETapi-users--user_id-">Get a single user.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    "http://socialplatform:82/api/auth/register" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://socialplatform:82/api/auth/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://socialplatform:82/api/auth/logout" \
    --header "Content-Type: application/json" \
...
<div class="bash-example">
    ...
    --get "http://socialplatform:82/api/user" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/user"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/profile" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/profile"
);
...
<div class="bash-example">
    ...
    --form "bio=hfqcoynlazghdtqtqxbaj"\
    --form "remove_avatar=1"\
    --form "avatar=@C:\Users\radyi\AppData\Local\Temp\phpA32A.tmp" </code></pre></div>
...
body.append('bio', 'hfqcoynlazghdtqtqxbaj');
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 500 characters. Example: <code>hfqcoynlazghdtqtqxbaj</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\radyi\AppData\Local\Temp\phpA32A.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "bio=hfqcoynlazghdtqtqxbaj"\
    --form "remove_avatar=1"\
    --form "avatar=@C:\Users\radyi\AppData\Local\Temp\phpA34A.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="bio"                data-endpoint="PATCHapi-profile"
               value="hfqcoynlazghdtqtqxbaj"
               data-component="body">
    <br>
<p>Must not be greater than 500 characters. Example: <code>hfqcoynlazghdtqtqxbaj</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="avatar"                data-endpoint="PATCHapi-profile"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\radyi\AppData\Local\Temp\phpA34A.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>remove_avatar</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/posts" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/posts"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/posts/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/posts/1"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/posts/1/comments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/posts/1/comments"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="body"                data-endpoint="POSTapi-posts--post_id--comments"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://socialplatform:82/api/comments/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"body\": \"vmqeopfuudtdsufvyvddq\"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="body"                data-endpoint="PUTapi-comments--comment_id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 2000 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<p>The ID of the comment. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-posts--post_id--like">POST api/posts/{post_id}/like</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://socialplatform:82/api/posts/1/like" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-posts--post_id--like">DELETE api/posts/{post_id}/like</h2>
...
<span id="example-requests-DELETEapi-posts--post_id--like">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-posts--post_id--like">
</span>
<span id="execution-results-DELETEapi-posts--post_id--like" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-posts--post_id--like"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-posts--post_id--like"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-posts--post_id--like" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-posts--post_id--like">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-posts--post_id--like" data-method="DELETE"
      data-path="api/posts/{post_id}/like"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-posts--post_id--like', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-posts--post_id--like"
                    onclick="tryItOut('DELETEapi-posts--post_id--like');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-posts--post_id--like"
                    onclick="cancelTryOut('DELETEapi-posts--post_id--like');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-posts--post_id--like"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-posts--post_id--like"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-posts--post_id--like"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="post_id"                data-endpoint="DELETEapi-posts--post_id--like"
               value="1"
               data-component="url">
    <br>
<p>The ID of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-posts--post_id--likes">GET api/posts/{post_id}/likes</h2>
...
<span id="example-requests-GETapi-posts--post_id--likes">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/posts/1/likes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/posts/1/likes"
);
...
<span id="example-responses-GETapi-posts--post_id--likes">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-posts--post_id--likes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-posts--post_id--likes"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-posts--post_id--likes"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-posts--post_id--likes" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-posts--post_id--likes">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-posts--post_id--likes" data-method="GET"
      data-path="api/posts/{post_id}/likes"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-posts--post_id--likes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-posts--post_id--likes"
                    onclick="tryItOut('GETapi-posts--post_id--likes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-posts--post_id--likes"
                    onclick="cancelTryOut('GETapi-posts--post_id--likes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-posts--post_id--likes"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/posts/{post_id}/likes</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-posts--post_id--likes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-posts--post_id--likes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="post_id"                data-endpoint="GETapi-posts--post_id--likes"
               value="1"
               data-component="url">
    <br>
<p>The ID of the post. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-friends">GET api/friends</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/friends" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/friends"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-friend-requests">GET api/friend-requests</h2>
...
<span id="example-requests-GETapi-friend-requests">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/friend-requests" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/friend-requests"
);
...
<span id="example-responses-GETapi-friend-requests">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-friend-requests" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-friend-requests"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-friend-requests"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-friend-requests" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-friend-requests">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-friend-requests" data-method="GET"
      data-path="api/friend-requests"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-friend-requests', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-friend-requests"
                    onclick="tryItOut('GETapi-friend-requests');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-friend-requests"
                    onclick="cancelTryOut('GETapi-friend-requests');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-friend-requests"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-friend-requests"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-friend-requests"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-friend-requests">POST api/friend-requests</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="receiver_id"                data-endpoint="POSTapi-friend-requests"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the users table. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-friend-requests--friend_request--accept">POST api/friend-requests/{friend_request}/accept</h2>
...
<span id="example-requests-POSTapi-friend-requests--friend_request--accept">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://socialplatform:82/api/friend-requests/1/accept" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-friend-requests--friend_request--accept">
</span>
<span id="execution-results-POSTapi-friend-requests--friend_request--accept" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-friend-requests--friend_request--accept"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-friend-requests--friend_request--accept"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-friend-requests--friend_request--accept" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-friend-requests--friend_request--accept">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-friend-requests--friend_request--accept" data-method="POST"
      data-path="api/friend-requests/{friend_request}/accept"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-friend-requests--friend_request--accept', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-friend-requests--friend_request--accept"
                    onclick="tryItOut('POSTapi-friend-requests--friend_request--accept');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-friend-requests--friend_request--accept"
                    onclick="cancelTryOut('POSTapi-friend-requests--friend_request--accept');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-friend-requests--friend_request--accept"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/friend-requests/{friend_request}/accept</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-friend-requests--friend_request--accept"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-friend-requests--friend_request--accept"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>friend_request</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_request"                data-endpoint="POSTapi-friend-requests--friend_request--accept"
               value="1"
               data-component="url">
    <br>
<p>Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-friend-requests--friend_request--reject">POST api/friend-requests/{friend_request}/reject</h2>
...
<span id="example-requests-POSTapi-friend-requests--friend_request--reject">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://socialplatform:82/api/friend-requests/1/reject" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-friend-requests--friend_request--reject">
</span>
<span id="execution-results-POSTapi-friend-requests--friend_request--reject" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-friend-requests--friend_request--reject"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-friend-requests--friend_request--reject"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-friend-requests--friend_request--reject" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-friend-requests--friend_request--reject">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-friend-requests--friend_request--reject" data-method="POST"
      data-path="api/friend-requests/{friend_request}/reject"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-friend-requests--friend_request--reject', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-friend-requests--friend_request--reject"
                    onclick="tryItOut('POSTapi-friend-requests--friend_request--reject');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-friend-requests--friend_request--reject"
                    onclick="cancelTryOut('POSTapi-friend-requests--friend_request--reject');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-friend-requests--friend_request--reject"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/friend-requests/{friend_request}/reject</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-friend-requests--friend_request--reject"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-friend-requests--friend_request--reject"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_request"                data-endpoint="POSTapi-friend-requests--friend_request--reject"
               value="1"
               data-component="url">
    <br>
<p>Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-friend-requests--friend_request-">DELETE api/friend-requests/{friend_request}</h2>
...
<span id="example-requests-DELETEapi-friend-requests--friend_request-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://socialplatform:82/api/friend-requests/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-DELETEapi-friend-requests--friend_request-">
</span>
<span id="execution-results-DELETEapi-friend-requests--friend_request-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-friend-requests--friend_request-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-friend-requests--friend_request-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-friend-requests--friend_request-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-friend-requests--friend_request-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-friend-requests--friend_request-" data-method="DELETE"
      data-path="api/friend-requests/{friend_request}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-friend-requests--friend_request-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-friend-requests--friend_request-"
                    onclick="tryItOut('DELETEapi-friend-requests--friend_request-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-friend-requests--friend_request-"
                    onclick="cancelTryOut('DELETEapi-friend-requests--friend_request-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-friend-requests--friend_request-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-red">DELETE</small>
            <b><code>api/friend-requests/{friend_request}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-friend-requests--friend_request-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-friend-requests--friend_request-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="friend_request"                data-endpoint="DELETEapi-friend-requests--friend_request-"
               value="1"
               data-component="url">
    <br>
<p>Example: <code>1</code></p>
                ...
                <h1 id="users">Users</h1>
                                ...
                                <h2 id="users-GETapi-users">Search users.</h2>

<p>
</p>

<p>Returns up to 20 users matching the given search term.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/users?q=john&amp;friends_only=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/users"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="q"                data-endpoint="GETapi-users"
               value="john"
               data-component="query">
    <br>
<p>The search term to look for in name or email. Example: <code>john</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>friends_only</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="GETapi-users" style="display: none">
            <input type="radio" name="friends_only"
                   value="1"
    ...
    <br>
<p>When true, limit results to the authenticated user's friends. Example: <code>true</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>q</code></b>&nbsp;&nbsp;
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="users-GETapi-users--user_id-">Get a single user.</h2>

<p>
</p>

<p>Returns the public profile information for the given user.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://socialplatform:82/api/users/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://socialplatform:82/api/users/1"
);
